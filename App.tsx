...
const DirectorRoutes = () => (
  <Layout>
    <Routes>
      ...
      <Route path="/asistencia" element={<PlaceholderPage title="Asistencia" description="Gestión de asistencia por QR, justificaciones y reportes." icon={ClipboardCheck} />} />
